...
interface ProductCardProps {
    ...
    onProductVariantDeleted: (id: number) => void;
}

export default function ProductCard({onProductDeleted, onProductVariantDeleted,product}: ProductCardProps) {
    ...
    return (
        <Card
            ...
            cover={
                product.imagem ? (
                    <Image
                        src={"http://localhost:3333"+product.imagem}
                        alt={product.nome}
